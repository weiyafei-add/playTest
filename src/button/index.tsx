...
import useURLLoader from '../customHook/useURLLoader';
...
const LikeButton:React.FC = () => {
    ...
    const [data, loading] = useURLLoader('https://dog.ceo/api/breeds/image/random',[status])
    ...
    return (
        <>
        <h1 style={style} className='hhhhh' >点击页面查看鼠标坐标 </h1>
        ...
        <h2>使用自定义hook获取图片</h2>
        {
            loading ? <p>正在加载图片</p> : <img src={ dogResult && dogResult.message} />
        }
        </>
    )
}
